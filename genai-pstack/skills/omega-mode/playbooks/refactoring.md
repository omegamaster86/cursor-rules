...
2. target shape を名指し。today build したら module layout、types、call graph がどうあるべきか（**principle-foundational-thinking**）。target が function boundary を越えるなら move 前に **architect** スキルで shape の parallel design exploration。
